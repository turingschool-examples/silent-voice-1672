...
RSpec.describe "Studio Index" do
  before(:each) do
    ...
    # @movie_1 = Movie.create!(title: "Bad Boys", creation_year: "1995", genre: "action", studio_id: @studio_1.id)
    # @movie_2 = Movie.create!(title: "Cars", creation_year: "2006", genre: "comedy", studio_id: 1)
    # @movie_3 = Movie.create!(title: "Friends", creation_year: "2010", genre: "romance", studio_id: 2)
    # @movie_4 = Movie.create!(title: "Startrek", creation_year: "1989", genre: "si-fi", studio_id: 2)
  end
